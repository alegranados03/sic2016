...
public class Asignacion_Orden extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Nombre del empleado a agregar:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nombre = (String) comboEmpleado.getSelectedItem();
           String sql = "SELECT id_empleado FROM empleado WHERE nombre= ? ;";
            try {
                ...
                while (result1.next()) {
                    dui = result1.getInt("id_empleado");
                }
...
private void FillcomboOrden() {
    ...
    private void FillcomboEmpleado() {
        try {
            ...
            ResultSet resultado1 = declaracion1.executeQuery();
            while (resultado1.next()) {
                String name = resultado1.getString("nombre");
